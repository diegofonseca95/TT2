...
const EditGroupPostCardFormValidateSettings = {
  rules : {
    'edit-group-post-card-title-input' : {
      required : true
    }
    /*,
    'edit-group-post-card-content' : {
      required : true
    }*/
  },
  messages : {
...
const EditGroupPostCardTinyMCESettings = {
...
/*
  This component represents the edit post card
  in the group blog view.
*/
Vue.component('edit-group-post-card', {
  props : [
  ...
  mounted : function(){
    var formSettings = EditGroupPostCardFormValidateSettings;
  ...
  methods : {
    handlePostUpdated : function(){
      ...
      // Validate the form.
      $('#edit-group-post-card-form').submit();
      /*if(!tinymce.get('edit-group-post-card-content').isDirty()){
    ...
    updatePost : function(){
      ...
      var requestBody = { 
        contenido : tinymce.get('edit-group-post-card-content').getContent(),
    ...
    resetFormFields : function(){
      ...
      var form = document.querySelector('#edit-group-post-card-form');
      // Reset the form.
      form.reset();
  ...
  template : `
    <div id="edit-group-post-card" class="card">
      <div class="card-content">
        <h4>Editar publicación</h4>
        <div class="row">
          <div class="row">
            <form class="col s12" id="edit-group-post-card-form">
              <div class="row">
                <div class="input-field col s12">
                  <textarea class="materialize-textarea"
                    name="edit-group-post-card-title-input"
                    id="edit-group-post-card-title-input"
                    v-model:value="newPostTitle"></textarea>
                  <label for="edit-group-post-card-title-input">
              ...
              <div class="row">
                <div class="input-field col s12">
                  <textarea class="materialize-textarea"
                    name="edit-group-post-card-content"
                    id="edit-group-post-card-content"></textarea>
                </div>
              </div>
            </form>
          </div>
