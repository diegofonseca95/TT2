...
"<ul id='dropdown"+this.post.id+"' class='dropdown-content'>" +
...
"<i data-target='dropdown"+this.post.id+"' class='dropdown-trigger material-icons right tooltipped' data-position='left' data-tooltip='Opciones'>more_vert</i>" +
"</a>" +
"</span>" +
