            ...
            "<div class='row'>" +
                ...
                "<div class='col s12'>" +
                    "<div class='col s4 offset-s2 m2 offset-m8 l3 offset-l5'>" +
                        "<a href='#!' class='btn red' title='Eliminar' v-on:click='deleteUser'>" +
                            "<i class='material-icons'>close</i>" +
                        "</a>" +
                    "</div>" +
                    "<div class='col s4 offset-s2 m2 l3 offset-l1'>" +
                        "<a href='#!' class='btn light-green accent-4' title='Aprobar'" +
                            " v-if='!user.valid' v-on:click='approveUser'>" +
                            "<i class='material-icons'>check</i>" +
                        "</a>" +
                        "<a href='#!' class='btn light-blue darken-2' title='Ver'" +
                            " v-if='user.valid' v-on:click='approveUser'>" +
