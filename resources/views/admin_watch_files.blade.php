...
<body class="page-background">
  ...
  <!-- Content begin -->
  <div class="container" id="admin-watch-files-box">
  ...
  <!-- Chat Ends -->
  <!-- List Items Begin -->
  <script src="/js/components/admin-watch-files/shared-files-project-list-item.js"></script>
  <script src="/js/components/admin-watch-files/shared-files-group-list-item.js"></script>
  <script src="/js/components/admin-watch-files/shared-files-list-item.js"></script>
  <!-- List Items End -->
  <!-- Lists Begin -->
  <!-- Lists End -->
  <!-- Modals Begin -->
  ...
  <!-- Card Groups End -->
  <!-- Others Begin -->
  <script src="/js/components/admin-watch-files/shared-files-project-list.js"></script>
  <script src="/js/components/admin-watch-files/shared-files-group-list.js"></script>
  <script src="/js/components/admin-watch-files/shared-files-list.js"></script>
  <script src="/js/components/admin-watch-files/shared-files-view.js"></script>
  <!-- Others End -->
  <!-- Vue Components End -->
  <script src="/js/global/admin/admin-watch-files.js"></script>
  <!-- Scripts End -->
</body>
